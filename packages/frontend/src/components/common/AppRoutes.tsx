...
export default function AppRoutes(props: AppRoutesProps) {
  ...
  return (
    <Routes>
      ...
      <Route
        path="/home"
        element={props.user ? <Home /> : <Navigate to="/login" state={{ from: location }} replace />}
      />
      <Route
      ...
      <Route
        path="/birthdays"
        element={props.user ? <Birthdays /> : <Navigate to="/login" state={{ from: location }} replace />}
      />
      <Route
        path="/family-tree"
        element={props.user ? <FamilyTree /> : <Navigate to="/login" state={{ from: location }} replace />}
      />
      <Route
        path="/subsystems/:sid/edit"
        element={props.user ? <SubsystemEdit /> : <Navigate to="/login" state={{ from: location }} replace />}
      />
      <Route
        path="/systems"
      ...
      <Route
        path="/did-system/:uid"
        element={props.user ? <DIDSystemView /> : <Navigate to="/login" state={{ from: location }} replace />}
      />
      ...
      <Route
        path="/admin"
        element={props.user ? <Admin /> : <Navigate to="/login" state={{ from: location }} replace />}
      />
      <Route
        path="/user-settings"
        element={props.user ? <UserSettings /> : <Navigate to="/login" state={{ from: location }} replace />}
      />
